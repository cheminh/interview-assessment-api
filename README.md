...
- a react app that reads rest `~/api/v1/provinces-territories` endpoint from your  `<PLACEHOLDER>-mu-ask-api-km` app and display Canadian provinces/territories information.
